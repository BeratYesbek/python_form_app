...
class FormDal:
    ...
    def getById(self, id):
        ...
        for doc in docs:
            ...
            formDto = FormDto(formId, documentId, str(senderId), formTitle, formDescription, date, userImage, userName,userType)
        return formDto
    ...
    def getAll(self):
        ...
        for doc in docs:
            ...
            userType = userData.userType
            formList.append(
                FormDto(formId, documentId, str(senderId), formTitle, formDescription, date, userImage, userName,userType))
